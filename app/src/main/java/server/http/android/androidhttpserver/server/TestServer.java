...
/**
 * Created by murrayking on 31/03/2016.
 */
public class TestServer extends NanoHTTPD {
        static final String TAG="TEAONLY";

        public TestServer(int port, Context ctx) throws IOException {
            super(port, ctx.getAssets());
        }

        public TestServer(int port, String wwwroot) throws IOException {
